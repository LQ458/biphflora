...
| Current deployed code commit          | 4168079                                                                   | Direct                  | Frontend API-routing hotfix; server marker, build hash, public checks, and browser acceptance agree             |
| Current deployment date               | 2026-07-23                                                                | Direct for this cutover | Frontend-only atomic build swap; historical deployment count remains unavailable                                |
...
| Production/staging/local relationship | Production code release 4168079; local branch also contains its incident report; no independent staging found | Direct/partial          | Isolated release checks and live browser smoke passed; staging parity and restore rehearsal remain unavailable |
