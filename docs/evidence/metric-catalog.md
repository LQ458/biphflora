...
| Current deployed code commit          | 5e8919a                                                                   | Direct                  | Responsive-media and evidence release; server-side marker, release hashes, and phase-12 acceptance record agree |
...
| Production/staging/local relationship | Production code release 5e8919a; local branch also contains its acceptance report; no independent staging found | Direct/partial          | Isolated release smoke passed; staging parity and restore rehearsal remain unavailable                       |
...
| Test coverage/CI/security scan                      | 39 backend and 17 frontend tests pass with a production build; CI workflow present; numeric coverage unavailable | Partial        | Production dependency audits report zero known issues; development trees and hosted CI history retain limitations documented in phase 12 |
