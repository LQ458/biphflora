      ...
      {displayObjectList[currentDisplayIndexes[index]] && (
        <div style={{ position: "relative" }}>
          <div className="artCodeT">
            <img
              className="art"
              src={`${process.env.REACT_APP_Source_URL}/public/compressed${displayObjectList[currentDisplayIndexes[index]].art}`}
              alt="art"
            />
            {admin && (
              <p
          ...
          <div className="subsubBox">
            <div>
              ...
              <div style={{ position: "relative", marginTop: "1.5rem" }}>
                <img
                  className="pic"
                  src={`${process.env.REACT_APP_Source_URL}/public/compressed${displayObjectList[currentDisplayIndexes[index]].pic}`}
                  alt="pic"
                />
                {admin && (
                  <p
      ...
      {displayObjectList[currentDisplayIndexes[index + 1]] ? (
        <div style={{ position: "relative" }}>
          <div className="artCodeT">
            <img
              className="art"
              src={`${process.env.REACT_APP_Source_URL}/public/compressed${displayObjectList[currentDisplayIndexes[index + 1]].art}`}
              alt="art"
            />
            {admin && (
              <p
          ...
          <div className="subsubBox">
            <div>
              ...
              <div style={{ position: "relative", marginTop: "1.5rem" }}>
                <img
                  className="pic"
                  src={`${process.env.REACT_APP_Source_URL}/public/compressed${displayObjectList[currentDisplayIndexes[index + 1]].pic}`}
                  alt="pic"
                />
                {admin && (
                  <p
