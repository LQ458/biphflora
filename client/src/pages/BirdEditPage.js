        ...
        <div className="textInfoEditBox">
          ...
          <div className={`${subpage && "textBtm"}`}>
            <div className="topBtm">
              ...
              <h3>Description 外貌特征: {props.editKey[0].appearance}</h3>
              <h3>Songs and Calls 鸣叫特征: {props.editKey[0].songs}</h3>
              <h3>Diet and Foraging 主要食谱与觅食行为: {props.editKey[0].diet}</h3>
              <h3>Habitat 栖息地: {props.editKey[0].habitat}</h3>
              <h3>Movements and Migration 迁徙行为: {props.editKey[0].migration}</h3>
              <h3>Breeding 繁育: {props.editKey[0].breeding}</h3>
              {/* <h3>Movements and Migration 迁徙行为: {item.migration}</h3> */}
              {/* <h3>Additional Info: {item.additionalInfo}</h3> */}
              <h3>Juvenile Charateristics: {props.editKey[0].juvChar}</h3>
              <h3>Sub-adult Charateristics: {props.editKey[0].subChar}</h3>
              <h3>Male Adult Characteristics: {props.editKey[0].mAdultChar}</h3>
              <h3>Female Adult Charateristics: {props.editKey[0].fAdultChar}</h3>
